...
var spr_jav_reg = preload("res://Textures/Items/Weapons/chef_scissor_3_new_attack.png")
var spr_jav_atk = preload("res://Textures/Items/Weapons/chef_scissor_3_new_attack.png")
...
func update_scissor():
	level = player.chef_scissor_level
	match level:
		1:
			hp = 9999
			speed = 200.0
